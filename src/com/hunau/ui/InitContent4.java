...
public class InitContent4 {
	...
	private JButton inBtn = new JButton("收入图表");
	private JButton outBtn = new JButton("支出图表");
	...
	public JPanel initContent() {
		...
		pan2.setBorder(BorderFactory.createTitledBorder("查询信息"));
	...
	public void initSet() {
		...
		inBtn.setFont(new Font("宋体", 1, 20));
		outBtn.setFont(new Font("宋体", 1, 20));
		...
		findBtn.setBounds(200, 400, 120, 60);
		inBtn.setBounds(350, 400, 120, 60);
		outBtn.setBounds(500, 400, 120, 60);
	}

	public void bindEvent() {
		Ctent4Control listener = new Ctent4Control(year, month, day, part);
		findBtn.addActionListener(listener);
		inBtn.addActionListener(listener);
		outBtn.addActionListener(listener);
	}
}
